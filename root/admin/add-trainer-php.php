...
$about_bb = filter_var($_POST['about_cc'], FILTER_SANITIZE_STRING);
$qualifications_bb = filter_var($_POST['qualifications_cc'], FILTER_SANITIZE_STRING);
$rate_bb = filter_var($_POST['rate_cc'], FILTER_SANITIZE_STRING);
...
$user_insert = "INSERT INTO users (email, username, password, user_type ) VALUES ('$email_bb', '$username_bb', '$password_bb', 'trainer');";

$result0 = mysqli_query($conn, $user_insert);

$trainer_insert = "INSERT INTO trainer (f_name, l_name, gender, phone_no, dob, address, about, qualifications,  username, rate) VALUES ('$f_name_bb', '$l_name_bb', '$gender_bb', '$phone_no_bb', '$dob_bb', '$address_bb', '$about_bb', '$qualifications_bb', '$username_bb', '$rate_bb');";
...
if ($result0 && $result1) {
    $_SESSION['notification'] = "Trainer successfully added";
