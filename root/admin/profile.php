                ...
                <div class="con1">
                    <div class="profcov2">
                        <div class="aper">
                            ...
                            <div class="pdetails">
                                <i class='bx bx-dumbbell'></i> NAME <p> <i class='bx bxs-right-arrow'></i>Thusitha Kakulawala</p>
            ...
            <div class="rsd">
                <div class="con1">
                    <form action="signup.php" class="form" id="signup_form" method="POST">
                        ...
                        <div class="topic">
                            <h2><i class='bx bx-pen'></i>Change E-mail</h2>
                        </div>
                        <div class="form__div">
                    ...
                    <div class="form__div" id="uname">
                        ...
                        <div class="topic">
                            <h2><i class='bx bx-pen'></i>Change Password</h2>
                        </div>
                        <div class="form__div">
