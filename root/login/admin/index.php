...
<head>
    ...
    <title>Admin Login - PH Fitness</title>
        ...
        <div class="login">
            <div class="l-form">
                <form action="login.php" class="form" id="form" method="POST">
                    <h1 class="form__title">ADMIN LOGIN<span id="Mem"></span></h1>
                    ...
                    <!-- <div class="signup">
                        <p>Don't have an account? <a href="../../login/admin/index.php" class="hover"> Sign up</a></p>
                    </div> -->
                    <div class="icon">
