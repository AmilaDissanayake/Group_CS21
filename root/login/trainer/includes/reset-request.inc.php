...
if (isset($_POST["reset-request-submit"])) {
    ...
    $mail_query = " SELECT COUNT(*) AS cntUser FROM trainer WHERE email = '" . $userEmail . "'";
    ...
    $url = "localhost/Group_CS21/root/login/trainer/create-new-password.php?selector=" . $selector . "&validator=" . bin2hex($token);
