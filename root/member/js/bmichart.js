...
function chartload() {
    ...
    if (membership == 12) {
        ctx.config.data.labels = ["Month 01", "Month 02", "Month 03", "Month 04", "Month 05", "Month 06", "Month 07", "Month 08", "Month 09", "Month 10", "Month 11", "Month 12"];
        ctx.update();
    } else if (membership == 6) {
        ctx.config.data.labels = ["Month 01", "Month 02", "Month 03", "Month 04", "Month 05", "Month 06"];
        ctx.update();
    } else if (membership == 3) {
        ctx.config.data.labels = ["Month01 1st 2-Weeks", "Month01 2nd 2-Weeks", "Month02 1st 2-Weeks", "Month02 2nd 2-Weeks", "Month03 1st 2-Weeks", "Month03 2nd 2-Weeks"];
        ctx.update();
    } else if (membership == 1) {
        ctx.config.data.labels = ["Week 01", "Week 02", "Week 03", "Week 04"];
        ctx.update();
    }
