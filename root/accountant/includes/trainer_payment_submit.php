<?php
    ...
    if(isset($_POST['form_submit'])){
        ...
        $sql1 = "SELECT trainer_id FROM trainer WHERE username = '".$username."' ";
        ...
        date_default_timezone_set('Asia/Colombo');
            ...
            $query4 = "UPDATE trainer_receviables SET  assignment_count = 0 , tr_recievable_amount=0 WHERE trainer_id = '".$trainer_id."'";
