...
<body>
    ...
    <section class="home-section">
        ...
        <div class="welcomenote"><h1>HI! NAVOD</h1></div>
                ...
                <div class="con1">
                    <div class="profcov2">
                        <div class="aper">
                            ...
                            <i class='bx bx-dumbbell'></i> CONTACT NO. <p> <i class='bx bxs-right-arrow'></i> 0751320001</p>
                            <i class='bx bx-dumbbell'></i> E-MAIL <p><i class='bx bxs-right-arrow'></i>def@gmail.conm</p>
                            </div>
                        </div>
                    </div>
                </div>
