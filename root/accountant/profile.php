...
<body>
    ...
    <section class="home-section">
        ...
        <?php
        $query1 = "SELECT * FROM accountant WHERE username = '" . $username . "'";
        ...
        <div class="home-content">
            <div class="cover">
                ...
                $image_select1 = "SELECT cover_image FROM accountant WHERE username='$username'";
            ...
            <div class="profile-img">
                ...
                $image_select = "SELECT image FROM accountant WHERE username='$username'";
